...
def test_physical_qualification_launcher_contract() -> None:
    ...
    require(
        "PASS trusted physical qualification launcher composition contract" in result.stdout,
...
def main() -> int:
    ...
    print(
        ...
        "causal takeoff, stale candidate rejection, actual host runner, trusted qualification launcher and controller-owned teardown"
    )
    return 0
