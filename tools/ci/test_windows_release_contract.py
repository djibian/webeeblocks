...
class WindowsReleaseContractTests(unittest.TestCase):
    ...
    def test_launcher_opens_only_packaged_world_with_r2025a(self) -> None:
        ...
        self.assertIn("Copy-Item -LiteralPath $PerspectivePath -Destination $sessionPerspective", launcher)
        ...
        self.assertIn("$sourcePerspectiveHash = (Get-FileHash -LiteralPath $worldPerspective -Algorithm SHA256).Hash", launcher)
        self.assertIn("La perspective de session ne preserve pas exactement la perspective de classe", launcher)
