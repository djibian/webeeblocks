...
{type:'webeeblocks_v2_takeoff',message0:'décoller à %1 m',args0:[{type:'field_number',name:'HEIGHT',value:0.5,min:0.2,max:1.5,precision:0.1}],previousStatement:null,nextStatement:null,colour:20},
{type:'webeeblocks_v2_land',message0:'atterrir',previousStatement:null,nextStatement:null,colour:20},
{type:'webeeblocks_v2_move',message0:'%1 de %2 m',args0:[{type:'field_dropdown',name:'DIRECTION',options:[['avancer','forward'],['reculer','back'],['aller à gauche','left'],['aller à droite','right']]},{type:'field_number',name:'DISTANCE',value:0.3,min:0.1,max:2.0,precision:0.1}],previousStatement:null,nextStatement:null,colour:20},
{type:'webeeblocks_v2_vertical',message0:'%1 de %2 m',args0:[{type:'field_dropdown',name:'DIRECTION',options:[['monter','up'],['descendre','down']]},{type:'field_number',name:'DISTANCE',value:0.2,min:0.1,max:0.8,precision:0.1}],previousStatement:null,nextStatement:null,colour:20},
