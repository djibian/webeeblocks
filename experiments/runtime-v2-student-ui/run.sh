...
python3 "$ROOT/experiments/runtime-v2-student-ui/probe_live_dropdown.py" --fixture "$FIXTURE" --expected-ast "$EXPECTED_AST" --output "$OUT/metrics.json" --screenshot "$OUT/workspace-1366x768.png"
