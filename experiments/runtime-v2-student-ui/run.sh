...
python3 "$ROOT/experiments/runtime-v2-student-ui/probe_post_hover_occupancy.py" --fixture "$FIXTURE" --expected-ast "$EXPECTED_AST" --output "$OUT/metrics.json" --screenshot "$OUT/workspace-1366x768.png"
