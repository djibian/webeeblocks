...
views = (
    ("top", [0.0, 0.0, 0.55], [0.0, 1.0, 0.0, 1.5707963267948966]),
    ("three-quarter", [-0.32, -0.32, 0.34], [-0.1565580108, 0.3779644730, 0.9124869568, 0.8522498022]),
    ("side", [0.0, -0.45, 0.18], [0.0, 0.0, 1.0, 1.5707963267948966]),
)
